...
class TestMap(unittest.TestCase):
    ...
    def test_map_center_distance_bev_translation_difference(self):
        """[summary]
        Test mAP and mAPH with center distance bev matching for translation difference.
    ...
    def test_map_center_distance_bev_yaw_difference(self):
        """[summary]
        Test mAP and mAPH with center distance bev matching for yaw difference.
    ...
    def test_map_center_distance_bev_random_objects(self):
        """[summary]
        Test mAP and mAPH with center distance bev matching for random objects.
