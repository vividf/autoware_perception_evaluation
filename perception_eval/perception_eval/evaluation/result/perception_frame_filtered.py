...
class PerceptionFrameFiltered:
    ...
    def evaluate_frame(self) -> None:
        ...
        estimated_objects_dict: Dict[LabelType, List[DynamicObject]] = divide_objects(
            self.estimated_objects,
            self.critical_object_filter_config.target_labels,
        )

        ground_truth_objects_dict: Dict[LabelType, List[DynamicObject]] = divide_objects(
        ...
        self.metrics_score.evaluate_detection(estimated_objects_dict, ground_truth_objects_dict, num_ground_truth_dict)
